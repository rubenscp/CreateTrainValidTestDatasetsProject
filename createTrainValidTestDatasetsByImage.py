...
if __name__ == '__main__':
    INPUT_DATASET_BY_CLASSES_PATH = '//InputData/'
    OUTPUT_TRAIN_VALID_TEST_DATASET_PATH = '//OutputData/'

    print('Cropping Annotated Bounding Boxes')
    print('---------------------------------')
    print('')
    print('Input images path - Cropped images path  : ', INPUT_DATASET_BY_CLASSES_PATH)
    ...
    processImages(INPUT_DATASET_BY_CLASSES_PATH, OUTPUT_TRAIN_VALID_TEST_DATASET_PATH,
                  percentageOfTrainImages, percentageOfValidImages, percentageOfTestImages)
